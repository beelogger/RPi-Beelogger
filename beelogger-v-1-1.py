# Beelogger Version 1.1, March 14th 2015
#! /bin/bash
#!/usr/bin/python
	...
	try:
		while (True):
			...
			with open(DATADIR + "/Beelogger_"+heute+'.csv',"a+",0) as csvfile:
				...
				writer.writerow( ("Datum", "Uhrzeit", "Temperatur1", "Temperatur2","Temperatur3","Gewicht1","Gewichtsabw1","Gewicht2", "Gewichtsabw2", "Gewicht3", "Gewichtsabw3", "Gewicht4", "Gewichtsabw4","Gesamtgewicht","Gewichtabw"
) )
				...
				while heute == datum:
					...
					gewichttotal = gewicht1+gewicht2+gewicht3+gewicht4
					gewichtabw = gewichtsabw1+gewichtsabw2+gewichtsabw3+gewichtsabw4
					writer.writerow( (datum, uhrzeit, temperatur_DS18S20_1, temperatur_DS18S20_2, temperatur3, gewicht1, gewichtabw1, gewicht2, gewichtabw2, gewicht3, gewichtabw3, gewicht4, gewichtabw4,gewichttotal, gewichtabw) )
					# run every 1 minute 
